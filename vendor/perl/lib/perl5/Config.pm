...
## Package name      : perl5
## Source directory  : .
## Configuration time: Mon Dec 30 15:37:39 GMT 2002
## Configured by     : dosuser
## Target system     : ms-dos athena 7 10 pc unknown 
#
## Configure command line arguments.
## Variables propagated from previous config.sh file.

my $config_sh = <<'!END!';
archlibexp='/dev/env/DJDIR/lib/perl5'
archname='dos-djgpp'
cc='gcc'
...
dlsrc='dl_none.xs'
dynamic_ext=''
extensions='B ByteLoader Data/Dumper Devel/DProf Devel/Peek Fcntl  GDBM_File IO NDBM_File ODBM_File Opcode POSIX SDBM_File Sys/Hostname attrs re Errno'
installarchlib='/dev/env/DJDIR/lib/perl5'
installprivlib='/dev/env/DJDIR/lib/perl5'
libpth='/dev/env/DJDIR/lib'
libs='-lgdbm -lm -lc'
osname='dos'
osvers='djgpp'
prefix='/dev/env/DJDIR'
privlibexp='/dev/env/DJDIR/lib/perl5'
sharpbang='#!'
shsharp='true'
sig_name='ZERO '
sig_num='0 '
so='none'
startsh='#! /bin/sh'
static_ext='B ByteLoader Data/Dumper Devel/DProf Devel/Peek Fcntl  GDBM_File IO NDBM_File ODBM_File Opcode POSIX SDBM_File Sys/Hostname attrs re'
Author=''
CONFIG='true'
CONFIGDOTSH='true'
Date='$Date'
...
Mcc='Mcc'
PATCHLEVEL='6'
PATH='/dev/env/DJDIR/bin;.;c:/windows;c:/windows/command;c:/djgpp/bin;/bin'
PERL_API_REVISION='5'
...
alignbytes='4'
ansi2knr=''
aphostname='/dev/env/DJDIR/bin/hostname.exe'
api_revision='5'
api_subversion='0'
api_version='5'
api_versionstring='5.005'
ar='ar.exe'
archlib='/dev/env/DJDIR/lib/perl5'
archname64=''
archobjs='djgpp.o'
awk='awk.exe'
baserev='5.0'
bash=''
bin='/dev/env/DJDIR/bin'
bincompat5005='define'
binexp='/dev/env/DJDIR/bin'
bison='bison.exe'
byacc='byacc'
byteorder='1234'
c=''
...
ccname='gcc'
ccsymbols='-Acpu=i386 -Amachine=i386 -Asystem=msdos -Asystem=unix GO32=1 MSDOS=1 __DJGPP__=2 __GNUC_MINOR__=2 __GNUC_PATCHLEVEL__=1 __GNUC__=3 __GO32__=1 __GXX_ABI_VERSION=102 __i386=1 __i386__=1 __MSDOS__=1 __NO_INLINE__=1 __STDC_HOSTED__=1 __tune_i586__=1 __tune_pentium__=1'
ccversion=''
cf_by='dosuser'
cf_email='rich@phekda.freeserve.co.uk'
cf_time='Mon Dec 30 15:37:39 GMT 2002'
charsize='1'
chgrp=''
chmod=''
chown=''
...
cpp='cpp.exe'
cpp_stuff='42'
cppccsymbols='DJGPP=2 i386=1 unix=1 __unix__=1'
cpplast='-'
cppminus='-'
cpprun='gcc -E'
cppstdin='gcc -E'
cppsymbols='__DJGPP=2 __DJGPP__=2 __GNUC__=3 __GNUC_MINOR__=2 __GNUC_MINOR__=2 GO32=1 __GO32__=1 __i386=1 __i386__=1 i386=1 __i386=1 __i386__=1 MSDOS=1 __MSDOS__=1 MSDOS=1 __MSDOS__=1 __STDC__=1 unix=1 __unix__=1'
crosscompile='undef'
cryptlib=''
csh='csh'
...
fpostype='fpos_t'
freetype='void'
full_ar='/dev/env/DJDIR/bin/ar.exe'
full_csh='csh'
full_sed='/dev/env/DJDIR/bin/sed.exe'
gccosandvers=''
gccversion='3.2.1'
gidformat='"ld"'
gidsign='-1'
...
incpath=''
inews=''
installbin='/dev/env/DJDIR/bin'
installman1dir='/dev/env/DJDIR/man/man1'
installman3dir=''
installprefix='/dev/env/DJDIR'
installprefixexp='/dev/env/DJDIR'
installscript='/dev/env/DJDIR/bin'
installsitearch='/dev/env/DJDIR/lib/perl5/site'
installsitebin='/dev/env/DJDIR/bin'
installsitelib='/dev/env/DJDIR/lib/perl5/site'
...
ivsize='4'
ivtype='long'
known_extensions='B ByteLoader DB_File Data/Dumper Devel/DProf Devel/Peek Fcntl  GDBM_File IO  NDBM_File ODBM_File Opcode POSIX SDBM_File Socket Sys/Hostname Sys/Syslog Thread attrs re'
ksh=''
ld='ld'
lddlflags=''
ldflags='-s'
...
less='less.exe'
lib_ext='.a'
libc='/dev/env/DJDIR/lib/libc.a'
libperl='libperl.a'
libsdirs=' /dev/env/DJDIR/lib'
libsfiles=' libgdbm.a libm.a libc.a'
libsfound=' /dev/env/DJDIR/lib/libgdbm.a /dev/env/DJDIR/lib/libm.a /dev/env/DJDIR/lib/libc.a'
libspath=' /dev/env/DJDIR/lib'
libswanted='sfio socket bind inet nsl nm ndbm gdbm dbm db malloc dl dld ld sun m c cposix posix ndir dir crypt sec ucb bsd BSD PW x iconv charset util'
...
mallocsrc=''
malloctype='void *'
man1dir='/dev/env/DJDIR/man/man1'
man1direxp='/dev/env/DJDIR/man/man1'
man1ext='1'
man3dir=' '
man3direxp=''
man3ext='0'
...
mv=''
myarchname='pc-dos'
mydomain='.int.phekda.freeserve.co.uk'
myhostname='athena'
myuname='ms-dos athena 7 10 pc unknown '
n='-n'
...
patchlevel='6'
path_sep=';'
perl5='/dev/env/DJDIR/bin/perl'
perl=''
perladmin='none'
perllibs='-lgdbm -lm -lc'
perlpath='/dev/env/DJDIR/bin/perl'
pg='pg'
phostname='hostname'
pidtype='pid_t'
...
pmake=''
pr=''
prefixexp='/dev/env/DJDIR'
privlib='/dev/env/DJDIR/lib/perl5'
prototype='define'
ptrsize='4'
quadkind='3'
quadtype='long long'
...
sSCNfldbl='"llf"'
sched_yield='undef'
scriptdir='/dev/env/DJDIR/bin'
scriptdirexp='/dev/env/DJDIR/bin'
sed='sed.exe'
seedfunc='srand48'
selectminbits='256'
selecttype='fd_set *'
sendmail=''
sh='/dev/env/DJDIR/bin/sh'
shar=''
shmattype=''
shortsize='2'
shrpenv=''
...
sig_num_init='0, 0'
signal_t='void'
sitearch='/dev/env/DJDIR/lib/perl5/site'
sitearchexp='/dev/env/DJDIR/lib/perl5/site'
sitebin='/dev/env/DJDIR/bin'
sitebinexp='/dev/env/DJDIR/bin'
sitelib='/dev/env/DJDIR/lib/perl5/site'
sitelib_stem='/dev/env/DJDIR/lib/perl5/site'
sitelibexp='/dev/env/DJDIR/lib/perl5/site'
siteprefix='/dev/env/DJDIR'
siteprefixexp='/dev/env/DJDIR'
sizesize='4'
sizetype='size_t'
sleep=''
smail=''
...
stdio_ptr='((fp)->_ptr)'
stdio_stream_array=''
strings='/dev/env/DJDIR/include/string.h'
submit=''
subversion='1'
sysman='/usr/man/man1'
tail=''
...
tee=''
test='test'
timeincl='/dev/env/DJDIR/include/sys/time.h '
timetype='time_t'
touch='touch.exe'
tr='tr.exe'
trnl='\012'
